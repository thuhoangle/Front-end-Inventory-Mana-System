...
const SideBar = () => {
    ...
    return (
        <NavigationMenu.Root orientation='vertical' className='h-screen w-[240px] bg-white px-4 pt-2 pb-2.5'>
            <div className='flex flex-col gap-5'>
                <p className='font-black text-4xl self-center'>Group1</p>
                <NavigationMenu.Item className='flex flex-row rounded-box gap-2.5 px-2.5 py-2.5 bg-lightBlue justify-start items-center'>
                    <Avatar.Root className='inline-flex h-11 w-11 items-center overflow-hidden rounded-full align-middle'>
                        <Avatar.Image className='h-full w-full rounded-[inherit] object-cover' src='src/assets/snoopy.jpeg' alt='avatar'>
                        </Avatar.Image>
                    </Avatar.Root>
            ...
            <div className='flex flex-col grow gap-4'>
                <NavigationMenu.List className='list-none gap-1 py-2 mt-2.5'>
                    <NavLink to='/dashboard' className={({ isActive }) => (isActive ? active : normal)}>
                        <NavigationMenu.Item className='justify-start items-center hover:bg-lightGray hover:text-gray-700 flex no-underline outline-none p-2.5 gap-4 text-xl font-semibold rounded-lg'>
                    ...
                    <NavLink to='/export' className={({ isActive }) => (isActive ? active : normal)}>
                        <NavigationMenu.Item className='justify-start items-center hover:bg-lightGray hover:text-gray-700 flex no-underline outline-none p-2.5 gap-3 text-xl font-semibold rounded-lg'>
