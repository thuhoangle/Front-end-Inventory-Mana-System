...
export default function Dashboard() {
    ...
    return (
      <container className=" min-h-screen ">
            <div className="grid col-span-10 gap-10 lg:grid-cols-3 py-6 p-10 ">
                ...
                <div className="flex flex-col gap-4 bg-white p-14">
                    <div className="inline-flex gap-2 self-start rounded-lg text-black border border-gray-100">
                        <svg width="70" height="70" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clipPath="url(#clip0_543_756)">
                                ...
                                <path fillRule="evenodd" clipRule="evenodd" d="M8.75 13.125C8.75 13.7052 8.98047 14.2616 9.3907 14.6718C9.80094 15.082 10.3573 15.3125 10.9375 15.3125H59.0625C59.6427 15.3125 60.1991 15.082 60.6093 14.6718C61.0195 14.2616 61.25 13.7052 61.25 13.125C61.25 12.5448 61.0195 11.9884 60.6093 11.5782C60.1991 11.168 59.6427 10.9375 59.0625 10.9375H10.9375C10.3573 10.9375 9.80094 11.168 9.3907 11.5782C8.98047 11.9884 8.75 12.5448 8.75 13.125ZM17.5 4.375C17.5 4.95516 17.7305 5.51156 18.1407 5.9218C18.5509 6.33203 19.1073 6.5625 19.6875 6.5625H50.3125C50.8927 6.5625 51.4491 6.33203 51.8593 5.9218C52.2695 5.51156 52.5 4.95516 52.5 4.375C52.5 3.79484 52.2695 3.23844 51.8593 2.8282C51.4491 2.41797 50.8927 2.1875 50.3125 2.1875H19.6875C19.1073 2.1875 18.5509 2.41797 18.1407 2.8282C17.7305 3.23844 17.5 3.79484 17.5 4.375Z" fill="black" />
                            </g>
                            <defs>
                        ...
                        <div className="flex-col justify-center items-start inline-flex px-10">
                            <span className="font-bold text-4xl">122</span>
                ...
                <div className="flex flex-col gap-4 rounded-lg border border-gray-100 bg-white p-14">
                    <div className="inline-flex gap-2 self-start rounded-lg text-black">
                        ...
                        <div className="flex-col justify-center items-start inline-flex px-10">
                            ...
                            <span className="text-2xl inline-flex">Processing orders</span>
                        </div>
                    </div>
                </div>
            ...
            <div className=" flex gap-5 px-10 py-6">
                <div className="bg-white basis-7/12 rounded-lg border border-gray-100">
                    <div className="text-start p-5 text-3xl font-bold">Low quantity stock</div>
                    <InfiniteScroll dataLength={dataSource.length} height={400}>
                        { dataSource.map((name,index) => {
                            return (
                                <tr key={index}>
                                <div className="p-7"> hello #{index}</div>
                                </tr>
                        );
                        })}
                    </InfiniteScroll>
